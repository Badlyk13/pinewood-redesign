...
export function Aurora({
  ...
  // eslint-disable-next-line react-hooks/refs -- Capture props for useEffect access
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line prefer-const -- Assigned later in function scope
    ...
    const update = (t: number) => {
      ...
      const { speed: spd } = propsRef.current;
      if (program) {
  ...
  return <div ref={ctnDom} className={className ?? "w-full h-full"} />;
}
